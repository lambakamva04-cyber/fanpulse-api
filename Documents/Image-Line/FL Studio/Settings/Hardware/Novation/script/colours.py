...
class Colours(CustomEnum):
    ...
    mixer_track_mute = 69, 94, 31
    mixer_track_select = 3
    mixer_track_pan = 255, 0, 0
    mixer_track_volume = 69, 94, 31
    pattern_selected = 3
    plugin_parameter = 0, 80, 255
    transport_play_on = 21
    transport_play_off = 23
    transport_record_on = 5
    transport_record_off = 7
    transport_song_position = 112, 255, 220
    transport_zoom = 0, 28, 255
    transport_marker = 90, 90, 90
    transport_tempo = 0, 142, 0
