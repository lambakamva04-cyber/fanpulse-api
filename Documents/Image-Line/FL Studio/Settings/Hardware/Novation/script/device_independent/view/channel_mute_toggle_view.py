...
class ChannelMuteToggleView(View):
    ...
    def __init__(self, action_dispatcher, product_defs, fl, model, button_led_writer, *, next_button_mode_function):
    ...
    def update_leds(self):
        self.turn_off_leds()
        mute_button = self.product_defs.FunctionToButton.get(self.next_button_mode_function)
        self.button_led_writer.set_button_colour(
            mute_button, Colours.mixer_track_mute.value, lighting_type=LedLightingType.RGB
        )
